...
{
public:
	Bullet(SceneObject *owner, D3DXVECTOR3 translation, D3DXVECTOR3 direction, float velocity, float range, float damage, char* meshName, char* meshPath = "./", unsigned long type = TYPE_SPAWNER_OBJECT);
	virtual ~Bullet();
