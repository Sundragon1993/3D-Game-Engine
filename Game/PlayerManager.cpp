...
{
	/*g_engine->GetSceneManager()->AddObject(m_anim = new AnimatedObject("Marine.x", "./Game/Test/Assets/"));
	m_anim->SetTranslation(100.0f, 900.0f, -100.0f);
	m_anim->SetFriction(5.0f);
	m_anim->PlayAnimation(4, true);*/
...
PlayerObject *PlayerManager::AddPlayer( PlayerInfo *player )
{
	...
	Script *script = new Script( ( (PlayerData*)player->data )->character, "./Game/Assets/Characters/" );
